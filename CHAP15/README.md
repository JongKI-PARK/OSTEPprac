...
<img src= "https://github.com/JongKI-PARK/OSTEPprac/blob/main/Images/chap15-1.png" width="50%" height="50%">  
...
In Chapter 15, we will see address translation via base-bound register. The problem of address translation via base-bound register is Internal fragmentation. The space between the process stack and heap is wasted.  


## Notice
The address translation techniques here are all mechanisms for dynamic placement in memory space.(Dynamic relocation)  
